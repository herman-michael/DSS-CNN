...
#DEFAULT_IMAGE_FOLDER_PATH = Path('dataset/coded/')
DEFAULT_IMAGE_FOLDER_PATH = Path('dataset/coded_noaug/')
...
class RegressionTaskData:
    ...
    def make_trainloader(self, batch_size: int = 64) -> torch.utils.data.DataLoader:
        ...
        """
        image_targets, image_classes = load_image_targets_from_csv(self.image_folder_path / 'ca_train.csv')
    ...
    def make_testloader(self, batch_size: int = 64) -> torch.utils.data.DataLoader:
        ...
        """
        image_targets, image_classes = load_image_targets_from_csv(self.image_folder_path / 'ca_test.csv')
    ...
    def make_validloader(self, batch_size: int = 64) -> torch.utils.data.DataLoader:
        ...
        """
        image_targets, image_classes = load_image_targets_from_csv(self.image_folder_path / 'ca_valid.csv')
