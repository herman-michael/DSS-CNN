...
from data_loading_ma_aug import RegressionTaskData
...
def evaluate_network(model, device,
    ...
    with torch.no_grad():
        ...
        np.savetxt('ma_aug_hist_alpha.csv', error_a_vec*180/pi*max_angle, delimiter=',')
        np.savetxt('ma_aug_hist_beta.csv', error_b_vec*180/pi*max_angle, delimiter=',')
        ...
        np.savetxt('ma_aug_actvspred_alpha.csv', actvspred_a.T, delimiter=',',
                   header='Output,Target,Error', comments='') 
        np.savetxt('ma_aug_actvspred_beta.csv', actvspred_b.T, delimiter=',',
                   header='Output,Target,Error', comments='') 
