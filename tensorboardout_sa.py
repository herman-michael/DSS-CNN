...
# Set the main path
directory_path = 'final_results/singleaperture_noaug/'
directory_path_aug = 'final_results/singleaperture_aug/'
...
plt.savefig("sa_lr.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
plt.xlabel('Steps')
# save the plot as PDF file
plt.savefig("sa_loss.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
plt.xlabel('Steps')
# save the plot as PDF file
plt.savefig("sa_r2.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
file_name = 'sa_noaug_errorimage_alpha.csv'
full_path = os.path.join(directory_path, file_name)
...
# save the plot as PDF file
plt.savefig("sa_hma.png", format='png', dpi=400, bbox_inches = "tight")
plt.show()
...
sns.set_context("paper", font_scale=1.5, rc={"lines.linewidth": 2.5})
# Load the error heatmap as a csv file
file_name = 'sa_noaug_errorimage_beta.csv'
full_path = os.path.join(directory_path, file_name)
...
plt.xticks(rotation=0) 
# save the plot as PDF file
plt.savefig("sa_hmb.png", format='png', dpi=400, bbox_inches = "tight")
plt.show()
...
# No augmentation
# Test
file_name = 'sa_noaug_hist_alpha.csv'
full_path = os.path.join(directory_path, file_name)
...
sns.despine()
# save the plot as PDF file
plt.savefig("sa_hista.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
# No augmentation
# Test
file_name = 'sa_noaug_hist_beta.csv'
full_path = os.path.join(directory_path, file_name)
...
sns.despine()
# save the plot as PDF file
plt.savefig("sa_histb.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
file_name = 'sa_noaug_actvspred_alpha.csv'
full_path = os.path.join(directory_path, file_name)
...
# save the plot as PDF file
plt.savefig("sa_pvaa.pdf", format='pdf', bbox_inches = "tight")
plt.show()
...
sns.set_context("paper")
sns.set_context("paper", font_scale=1.5, rc={"lines.linewidth": 2.5})
file_name = 'sa_noaug_actvspred_beta.csv'
full_path = os.path.join(directory_path, file_name)
...
plt.legend(["Ideal" , "Predictions - Test"])
# save the plot as PDF file
plt.savefig("sa_pvab.pdf", format='pdf', bbox_inches = "tight")
plt.show()