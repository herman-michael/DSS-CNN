...
from data_loading_sa import RegressionTaskData
...
def evaluate_network(model, device,
    ...
    with torch.no_grad():
        ...
        np.savetxt('sa_noaug_hist_alpha.csv', error_a_vec*180/pi*max_angle, delimiter=',')
        np.savetxt('sa_noaug_hist_beta.csv', error_b_vec*180/pi*max_angle, delimiter=',')
        ...
        # np.savetxt('sa_noaug_actvspred_alpha.csv', actvspred_a.T, delimiter=',',
        #            header='Output,Target,Error', comments='') 
        # np.savetxt('sa_noaug_actvspred_beta.csv', actvspred_b.T, delimiter=',',
        #            header='Output,Target,Error', comments='') 
